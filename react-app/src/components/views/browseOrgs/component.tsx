...
> {
  ...
  renderSearchFeedback() {
    ...
    if (this.props.totalCount === this.props.filteredCount) {
      return (
        <div className="OrganizationsBrowser-searchFeedback">
          <b>{this.props.totalCount}</b> orgs
        </div>
      );
    }
    ...
    return (
      <div className="OrganizationsBrowser-searchFeedback">
        <b>{this.props.filteredCount}</b>/{this.props.totalCount} orgs
      </div>
    );
  }
  ...
  renderSearchForm() {
    return (
      <div id="searchForm" className="OrganizationsBrowser-searchBar">
        <Search
  ...
  renderSortByControl() {
    return (
      <Select
        ...
        style={{ width: "10em" }}
      >
        <Select.Option value="recentlyChanged" key="changed">
          Date Changed
        </Select.Option>
        <Select.Option value="recentlyAdded" key="recent">
          Date Established
        </Select.Option>
        <Select.Option value="name" key="name">
          Org Name
        </Select.Option>
        <Select.Option value="memberCount" key="memberCount">
          # members
        </Select.Option>
  ...
  renderOrganizations() {
    if (this.props.error) {
      ...
      if (
        this.props.filter.roleType === "myorgs" &&
  ...
  renderFilterColumn() {
    return (
      <React.Fragment>
        ...
        <div style={{ marginTop: "15px" }}>{this.renderAdvancedToggle()}</div>
