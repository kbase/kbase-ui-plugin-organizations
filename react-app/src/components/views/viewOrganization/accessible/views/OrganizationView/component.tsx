...
class OrganizationView extends React.Component<OrgViewProps, OrgViewState> {
    ...
    renderAdminTasks() {
        ...
        const title = (
            <span>
                <UnlockOutlined /> group requests <span className="OrganizationView-titleCount">({count})</span>
            </span>
        );
        return (
    ...
    renderCombo() {
        ...
        tabs.push(
            <Tabs.TabPane
                tab={
                    <span>
                        <TeamOutlined />
                        Members <span className="OrganizationView-tabCount">({memberCount})</span>
                    </span>
                }
                key="members"
        ...
        if (isMember) {
            if (isAdmin) {
                ...
                const totalRequests = <span className="OrganizationView-tabCount">({totalRequestCount || 'Ø'})</span>;
                tabs.push(
                    <Tabs.TabPane
                        tab={
                            <span>
                ...
                tabs.push(
                    <Tabs.TabPane
                        tab={
                            <span>
                                <InboxOutlined />
                                Requests <span className="OrganizationView-tabCount">({titleCount})</span>
                            </span>
                        }
                        key="outbox"
                        style={{ flexDirection: 'column' }}
        ...
        const relatedOrgTab = (
            <span>
                <TeamOutlined />
                Related Orgs <span className="OrganizationView-tabCount">({relatedOrgCount})</span>
            </span>
        );
        tabs.push(
        ...
        return (
            <span className="ButtonSet">
                <span className="ButtonSet-button">
                    <div className="IconButton" onClick={this.onNavigateToOrgsBrowser.bind(this)}>
                        <CloseOutlined />
                    </div>
                </span>
            </span>
    ...
    renderMainTabs() {
        ...
        const narrativesTabTitle = (
            <span>
                <FileOutlined />
                Narratives <span className="OrganizationView-tabCount">({narrativeCount})</span>
            </span>
        );
    ...
    render() {
        return (
            <div className="OrganizationView-mainRow scrollable-flex-column">
                <div className="OrganizationView-mainColumn  scrollable-flex-column">{this.renderMainTabs()}</div>
