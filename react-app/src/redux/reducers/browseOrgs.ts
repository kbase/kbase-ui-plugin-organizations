...
// FOR NOW:
// do it here...
export function searchOrgs(state: BrowseOrgsViewModel, action: actions.SearchOrgs): BrowseOrgsViewModel {
...
export function searchOrgsStart(state: BrowseOrgsViewModel, action: actions.SearchOrgsStart): BrowseOrgsViewModel {
    if (state.loadingState !== AsyncModelState.SUCCESS) {
        return state;
    }
    return {
...
export function searchOrgsSuccess(state: BrowseOrgsViewModel, action: actions.SearchOrgsSuccess): BrowseOrgsViewModel {
    if (state.loadingState !== AsyncModelState.SUCCESS) {
        return state;
    }
    return {
...
export function searchOrgsError(state: BrowseOrgsViewModel, action: actions.SearchOrgsError): BrowseOrgsViewModel {
    if (state.loadingState !== AsyncModelState.SUCCESS) {
        return state;
    }
...
export function sortOrgsStart(state: BrowseOrgsViewModel, action: actions.SortOrgsStart): BrowseOrgsViewModel {
    if (state.loadingState !== AsyncModelState.SUCCESS) {
        return state;
    }
...
function filterOrgsStart(state: BrowseOrgsViewModel, action: actions.FilterOrgsStart): BrowseOrgsViewModel {
    if (state.loadingState !== AsyncModelState.SUCCESS) {
        return state;
    }
...
function loadStart(state: BrowseOrgsViewModel, action: actions.LoadStart): BrowseOrgsViewModel {
    return {
        loadingState: AsyncModelState.LOADING
    };
}

function loadError(state: BrowseOrgsViewModel, action: actions.LoadError): BrowseOrgsViewModel {
    return {
...
function loadSuccess(state: BrowseOrgsViewModel, action: actions.LoadSuccess): BrowseOrgsViewModel {
...
function unload(state: BrowseOrgsViewModel, action: actions.Unload): BrowseOrgsViewModel {
    return {
        loadingState: AsyncModelState.NONE
    };
}

function localReducer(state: BrowseOrgsViewModel, action: Action): BrowseOrgsViewModel | null {
...
export default function reducer(state: StoreState, action: Action<any>): StoreState | null {
    ...
    const browseOrgsView = localReducer(state.view.value.views.browseOrgs, action);
    if (browseOrgsView) {
        return {
            ...state,
            view: {
