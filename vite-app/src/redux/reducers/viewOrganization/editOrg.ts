...
export function loadStart(
  _state: AsyncModel<EditOrgViewModel>,
  _action: LoadStart,
): AsyncModel<EditOrgViewModel> {
  return {
...
export function editOrgSaveStart(
  state: AsyncModel<EditOrgViewModel>,
  _action: EditOrgSaveStart,
): AsyncModel<EditOrgViewModel> {
...
export function editOrgSaveSuccess(
  state: AsyncModel<EditOrgViewModel>,
  _action: EditOrgSaveSuccess,
): AsyncModel<EditOrgViewModel> {
  if (state.loadingState !== AsyncModelState.SUCCESS) {
    return state;
  }
...
export function editOrgSaveError(
  state: AsyncModel<EditOrgViewModel>,
  action: EditOrgSaveError,
): AsyncModel<EditOrgViewModel> {
  if (state.loadingState !== AsyncModelState.SUCCESS) {
    return state;
  }
...
export function editOrgEvaluateOk(
  state: AsyncModel<EditOrgViewModel>,
  _action: EditOrgEvaluateOK,
): AsyncModel<EditOrgViewModel> {
  if (state.loadingState !== AsyncModelState.SUCCESS) {
    return state;
  }
...
export function editOrgEvaluateErrors(
  state: AsyncModel<EditOrgViewModel>,
  _action: EditOrgEvaluateErrors,
): AsyncModel<EditOrgViewModel> {
  if (state.loadingState !== AsyncModelState.SUCCESS) {
    return state;
  }
...
export function editOrgUpdateNameSuccess(
  state: AsyncModel<EditOrgViewModel>,
  action: EditOrgUpdateNameSuccess,
): AsyncModel<EditOrgViewModel> {
  if (state.loadingState !== AsyncModelState.SUCCESS) {
    return state;
  }
...
// Logo url
export function editOrgUpdateLogoUrlSuccess(
  state: AsyncModel<EditOrgViewModel>,
...
export function editOrgUpdateLogoUrlError(
  state: AsyncModel<EditOrgViewModel>,
...
// Logo url
export function editOrgUpdateHomeUrlSuccess(
  state: AsyncModel<EditOrgViewModel>,
...
export function editOrgUpdateHomeUrlError(
  state: AsyncModel<EditOrgViewModel>,
...
export function updateDescriptionSuccess(
  state: AsyncModel<EditOrgViewModel>,
  action: EditOrgUpdateDescriptionSuccess,
): AsyncModel<EditOrgViewModel> {
  if (state.loadingState !== AsyncModelState.SUCCESS) {
    return state;
  }
...
export function editOrgUpdateDescriptionError(
  state: AsyncModel<EditOrgViewModel>,
  action: EditOrgUpdateDescriptionError,
): AsyncModel<EditOrgViewModel> {
  if (state.loadingState !== AsyncModelState.SUCCESS) {
    return state;
  }
...
export function localReducer(
  state: AsyncModel<EditOrgViewModel>,
  action: Action,
): AsyncModel<EditOrgViewModel> | null {
  // NB using discriminant union nature of the ActionX types to narrow
  // the type.
  ...
  switch (action.type) {
    ...
    case ActionFlag.EDIT_ORG_UPDATE_NAME_SUCCESS:
      return editOrgUpdateNameSuccess(
        state,
        action as EditOrgUpdateNameSuccess,
      );
    case ActionFlag.EDIT_ORG_UPDATE_NAME_ERROR:
    ...
    case ActionFlag.EDIT_ORG_UPDATE_DESCRIPTION_SUCCESS:
      return updateDescriptionSuccess(
        state,
        action as EditOrgUpdateDescriptionSuccess,
      );
    case ActionFlag.EDIT_ORG_UPDATE_DESCRIPTION_ERROR:
      return editOrgUpdateDescriptionError(
        state,
        action as EditOrgUpdateDescriptionError,
      );
    case ActionFlag.EDIT_ORG_EVALUATE_OK:
...
export default function reducer(
  ...
  const newViewModel = localReducer(
