...
export function loadStart(
  _state: AsyncModel<ManageMembershipViewModel>,
  _action: actions.LoadStart,
): AsyncModel<ManageMembershipViewModel> {
  return {
...
export function updateTitleSuccess(
  state: AsyncModel<ManageMembershipViewModel>,
  action: actions.UpdateTitleSuccess,
): AsyncModel<ManageMembershipViewModel> {
...
function evaluateSuccess(
  state: AsyncModel<ManageMembershipViewModel>,
  _action: actions.EvaluateSuccess,
): AsyncModel<ManageMembershipViewModel> {
  if (state.loadingState !== AsyncModelState.SUCCESS) {
    return state;
  }
...
function localReducer(
  state: AsyncModel<ManageMembershipViewModel>,
  action: Action,
): AsyncModel<ManageMembershipViewModel> | null {
  switch (action.type) {
