...
export function loadStart(
  _state: ManageOrganizationRequestsViewModel,
  _action: actions.LoadStart,
): ManageOrganizationRequestsViewModel {
  return {
...
export function getViewAccessSuccess(
  ...
  action: actions.GetViewAccessSuccess,
): ManageOrganizationRequestsViewModel {
...
function localReducer(
  state: ManageOrganizationRequestsViewModel,
  action: Action,
): ManageOrganizationRequestsViewModel | null {
  switch (action.type) {
    ...
    case ActionFlag.ADMIN_MANAGE_REQUESTS_GET_VIEW_ACCESS_SUCCESS:
      return getViewAccessSuccess(
        state,
        action as actions.GetViewAccessSuccess,
      );
    default:
      return null;
  }
